...
- [juniorsundar/cling.nvim](https://github.com/juniorsundar/cling.nvim) - Thin wrapper around your command-line; Provides Emacs' `M-x compile`, and the ability to wrap CLIs and TUIs as native Neovim commands with auto-generated tab-completions.
<!--lint disable double-link -->
[**⬆ back to top**](#contents)
<!--lint enable double-link -->
